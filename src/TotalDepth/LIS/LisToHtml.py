...
# TODO: Fix this global usage.
INCLUDE_LR_TYPE_UNKNOWN_INTERNAL_FORMAT = False
...
Generates HTML from input LIS file or directory to an output destination."""
    ...
    global INCLUDE_LR_TYPE_UNKNOWN_INTERNAL_FORMAT
    INCLUDE_LR_TYPE_UNKNOWN_INTERNAL_FORMAT = args.include_unknown_internal_format
    # print('TRACE:', INCLUDE_LR_TYPE_UNKNOWN_INTERNAL_FORMAT)
    # print(args)
    # return 0
