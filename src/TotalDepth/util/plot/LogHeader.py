...
STATICS = [
    ...
    Static(1.15 + 1 / 6 + 2.7 + 0.5, 2.7, 0.5, 1 / 6, 'KB', FONT_PROP, 9, TEXT_ATTRS_FINE, None, Mnem.Mnem(b'EKB '),
           0.25),
    Static(1.15 + 1 / 6 + 2.7 + 0.5, 2.85, 0.5, 1 / 6, 'GL', FONT_PROP, 9, TEXT_ATTRS_FINE, None, Mnem.Mnem(b'EGL '),
           0.25),
    Static(1.15 + 1 / 6 + 2.7 + 0.5, 3.0, 0.5, 1 / 6, 'DF', FONT_PROP, 9, TEXT_ATTRS_FINE, None, Mnem.Mnem(b'EDF '),
           0.25),
    # Boxes for datums
    Static(1.15 + 1 / 6, 3.2, 4.75 + 3 / 16, 0.5, None, FONT_PROP, 9, TEXT_ATTRS_FINE, RECT_ATTRS_FINE, None, None),
    Static(1.15 + 1 / 6, 3.2, 1.5, 1 / 6, 'Permanent Datum:', FONT_PROP, 9, TEXT_ATTRS_FINE, None, Mnem.Mnem(b'PDAT'),
           1.25),
    Static(1.15 + 1 / 6, 3.35, 1.5, 1 / 6, 'Log Measured From:', FONT_PROP, 9, TEXT_ATTRS_FINE, None,
           Mnem.Mnem(b'LMF '), 1.25),
    Static(1.15 + 1 / 6, 3.5, 1.5, 1 / 6, 'Drilling Measured From:', FONT_PROP, 9, TEXT_ATTRS_FINE, None,
           Mnem.Mnem(b'DMF '), 1.25),
    Static(1.15 + 1 / 6 + 2.7, 3.2, 0.5, 1 / 6, 'Elev:', FONT_PROP, 9, TEXT_ATTRS_FINE, None, None, None),
    Static(1.15 + 1 / 6 + 3.5, 3.35, 0.5, 1 / 6, 'above permanent datum', FONT_PROP, 9, TEXT_ATTRS_FINE, None,
           Mnem.Mnem(b'APD '), -0.75),
    # Well deviation
...
for __i, (__t, __m) in enumerate(
    ...
    STATICS.append(
        Static(2.0, 4. + __i * 1 / 6, 2, 1 / 6, None, FONT_PROP, 9, TEXT_ATTRS_FINE, RECT_ATTRS_FINE, None, None))
...
for __i in sorted(__MNEM_FINE_MAP.keys()):
    ...
    for __j, __m in enumerate(__MNEM_FINE_MAP[__i]):
        STATICS.append(
            Static(2.875, 4. + __i * 1 / 6, 0.25, 1 / 6, None, FONT_PROP, 9, TEXT_ATTRS_FINE, None, Mnem.Mnem(__m),
                   -0.875 + __j * 1.125))
...
STATICS.append(
    Static(2.0, 4. + 17 * 1 / 6, 1.0, 1 / 6, None, FONT_PROP, 9, TEXT_ATTRS_FINE, RECT_ATTRS_FINE, Mnem.Mnem(b'RMB '),
           0.0))
STATICS.append(
    Static(3.0, 4. + 17 * 1 / 6, 1.0, 1 / 6, None, FONT_PROP, 9, TEXT_ATTRS_FINE, RECT_ATTRS_FINE, Mnem.Mnem(b'RMFB'),
           0.0))
