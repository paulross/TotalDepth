...
# This is a placeholder that can be replaced by 'TotalDepth/RP66V1/core/cStorageUnitLabel.so'
#     Extension(
#         'TotalDepth.RP66V1.core.cStorageUnitLabel',
#         sources=[
#             'src/TotalDepth/RP66V1/core/src/cpy/cStorageUnitLabel.cpp',
#             'src/TotalDepth/RP66V1/core/src/cpp/StorageUnitLabel.cpp',
#         ],
