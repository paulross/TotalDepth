...
@pytest.mark.parametrize(
    ...
    (
            ...
            (
                    ...
                    None,
                    np_summary.ArraySummary(len=8, shape=(8,), count=8, min=1.0, max=128.0, mean=31.875,
                                            std=41.40784195052913,
            ...
            (
                    ...
                    91.0,
                    np_summary.ArraySummary(len=10, shape=(8,), count=8, min=1.0, max=128.0, mean=31.875,
                                            std=41.40784195052913,
                                            median=12.0, count_eq=0, count_dec=0, count_inc=7, activity=1.0,
                                            first=1.0, last=128.0)
            ),
