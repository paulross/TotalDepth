...
class TestLineTrans(unittest.TestCase):
    ...
    def test_40_01(self):
        ...
        self.assertRaises(PRESCfg.ExceptionLineTransBase, PRESCfg.LineTransLin, 8.0, 0.0, 0.0, 64.0,
                          backup=PRESCfg.BACKUP_ONCE)
    ...
    def test_40_03(self):
        ...
        self.assertRaises(PRESCfg.ExceptionLineTransBase, PRESCfg.LineTransLin, 8.0, 0.0, 64.0, 0.0,
                          backup=PRESCfg.BACKUP_ONCE)
...
class TestPRESReadMultiFilm(BaseTestClasses.TestBaseFile):
    ...
    def setUp(self):
        ...
        # Check we can get the film destinations
        self.assertEqual(sorted([Mnem.Mnem(b'B'), Mnem.Mnem(b'A')]),
                         sorted(self._filmCfgAlpha.retAllFILMDestS(b'BOTH')))
